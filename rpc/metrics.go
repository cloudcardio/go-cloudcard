...
// Metrics for rpc
var (
	metricsRPCCounter = metrics.NewMeter("cloudcard.rpc.request")

	metricsUnlockSuccess = metrics.NewMeter("cloudcard.rpc.unlock.success")
	metricsUnlockFailed  = metrics.NewMeter("cloudcard.rpc.unlock.failed")
)
