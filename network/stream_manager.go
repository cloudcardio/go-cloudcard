...
func (sm *StreamManager) Start() {
	logging.CLog().Info("Starting cloudcardService StreamManager...")

	go sm.loop()
}

func (sm *StreamManager) loop() {
	logging.CLog().Info("Started cloudcardService StreamManager.")
...
func (sm *StreamManager) Stop() {
	logging.CLog().Info("Stopping cloudcardService StreamManager...")
